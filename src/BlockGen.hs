...
--genTable :: [String] -> Int -> Map String Int -> Map String Int
--genTable (n : names) index table
--  = genTable names (index + 1) (Map.insert n index table)
--genTable [] _ t = t
--

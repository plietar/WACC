...
\section{Product}
Here follows an analytic and critical evaluation of our WACC compiler, which we have written in Haskell. Haskell has allowed us to use powerful pattern matching and monads to write our compiler. Being extremely critical, we think we have built a fantastic compiler; standing not just up to the expectations of the test cases, but with good code design and a lot of extended and additional fuctionality.
